...
public class Constants {
    ...
    public static class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.mitchbarry.android.whoisit";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Who Is It";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.mitchbarry.android.whoisit.sync";
    ...
    public static class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.mitchbarry.android.whoisit.";
